...
import com.ford.security.app.pojo.FordJwtTokenEnhancer;
...
public class TokenStoreConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "ford.security.oauth2", name = "tokenStore", havingValue = "redis")
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "ford.security.oauth2", name = "tokenStore", havingValue = "jwt", matchIfMissing = true)
    public static class JwtConfig {

        @Autowired
        private FordSecurityProperties securityProperties;
        ...
        public TokenEnhancer jwtTokenEnhancer() {
            return new FordJwtTokenEnhancer();
        }
    }
}
