package com.ford.security.app.authentication;
 ...
 */
@Slf4j
@Component(value = "FordAuthenticationSuccessHandler")
public class FordAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
