...
import com.ford.security.core.social.FordSpringSocialConfigurer;
...
public class SpringSocialConfigurerPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if(StringUtils.equals(beanName, "fordSocialSecurityConfig")){
            FordSpringSocialConfigurer config = (FordSpringSocialConfigurer)bean;
