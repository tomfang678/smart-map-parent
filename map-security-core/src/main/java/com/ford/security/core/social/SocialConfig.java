...
public class SocialConfig extends SocialConfigurerAdapter {
    ...
    public SpringSocialConfigurer springSocialSecurityConfig() {
        ...
        String filterProcessesUrl = fordSecurityProperties.getSocial().getFilterProcessesUrl();
        FordSpringSocialConfigurer configurer = new FordSpringSocialConfigurer(filterProcessesUrl);

        //指定SpringSocial/SpringSecurity跳向注册页面时的url为我们配置的url
        configurer.signupUrl(fordSecurityProperties.getBrowser().getSignUpUrl());
