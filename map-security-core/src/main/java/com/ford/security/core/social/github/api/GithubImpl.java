...
*/
     ...
     */
    private static final String URL_GET_OPENID = "https://github.com/login/oauth/authorize?client_id=%s&state=STATE&redirect_uri=%s";
    ...
    public GithubInfo getUserInfo() {
        ...
        try {
            ...
            userInfo = JSON.parseObject(result, GithubInfo.class);
