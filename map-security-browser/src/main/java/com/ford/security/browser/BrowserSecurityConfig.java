...
import com.ford.security.core.AbstractChannelSecurityConfig;
...
public class BrowserSecurityConfig extends AbstractChannelSecurityConfig {
    ...
    @Autowired
    private UserDetailsService fordDetailsService;
        ...
        http.apply(validateCodeSecurityConfig)
                ...
                .and()
                    ...
                    .rememberMe()
                        ...
                        .tokenValiditySeconds(fordSecurityProperties.getBrowser().getRememberMeSeconds())
                        .userDetailsService(fordDetailsService)
                .and()
                    //session相关的控制
                    .sessionManagement()
                        //指定session失效策略
                        ...
                        .maximumSessions(fordSecurityProperties.getBrowser().getSession().getMaximumSessions())
                        //当超过指定的最大session并发数量时，阻止后面的登陆（感觉貌似很少会用到这种策略）
                        .maxSessionsPreventsLogin(fordSecurityProperties.getBrowser().getSession().isMaxSessionsPreventsLogin())
                        //超过最大session并发数量时的策略
