package com.ford.security.browser.logout;
 ...
 */
@Slf4j
public class FordLogoutSuccessHandler implements LogoutSuccessHandler {
    /**
     * 退出登陆url
    ...
    public FordLogoutSuccessHandler(String signOutSuccessUrl) {
